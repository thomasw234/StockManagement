...
namespace GTill
{
    class frmLookupTransactions : Form
    {
        ...
        void ShowTransaction(string sTransactionNumber)
        {
            ...
            lblOtherInfo[0].Text = "Net Amount : " + tillEngine.GetCurrencySymbol().ToString() + TillEngine.TillEngine.FormatMoneyForDisplay(tillEngine.fFixFloatError(fNetAmount));
            lblOtherInfo[1].Text = "Discount : " + tillEngine.GetCurrencySymbol().ToString() + TillEngine.TillEngine.FormatMoneyForDisplay(TillEngine.TillEngine.FixFloatError(fDiscount));
            lblOtherInfo[2].Text = "Total : " + tillEngine.GetCurrencySymbol().ToString() + TillEngine.TillEngine.FormatMoneyForDisplay(TillEngine.TillEngine.FixFloatError(fNetAmount - fDiscount));
