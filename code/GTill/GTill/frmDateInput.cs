...
namespace GTill
{
    class frmDateInput : Form
    {
        ...
        /// <summary>
        /// If it's Sunday, then return Monday's date
        /// </summary>
        /// <returns></returns>
        ...
        public void SetupForm()
        {
            if (DateTime.Now.DayOfWeek == DayOfWeek.Sunday)
            {
                MessageBox.Show("Monday's date has been entered. Please leave this as it is");
            }
            ...
            lblInstruction.Text = "Today's date is " + getDateToUse() + ", press enter to confirm that this is correct, or enter the correct date (DDMMYYYY).";
