...
{
    class frmDetailedItemEnquiry_exp : ScalableForm
    {
        StockEngine sEngine;
        Label lblTitle;
        Label lblShopName;
        ...
        BackOffice.Objects.Items.MasterItem item;
        ...
        public frmDetailedItemEnquiry_exp(ref StockEngine se, string sItemToShow)
        {
            sEngine = se;
        ...
        void frmDetailedItemEnquiry_Paint(object sender, PaintEventArgs e)
        {
            ...
            lblQuantOnOrder.Left = this.Width 
                
                
                - lblQuantOnOrder.Width;
            lblUnits.Left = this.Width - 20 - lblUnits.Width;
        }
        ...
        void SetupForm()
        {
            ...
            lblUnits.Location = new Point(this.Width - 20 - lblUnits.Width, 90);
            ...
            lblQuantOnOrder.Location = new Point(this.Width - 20 - lblQuantOnOrder.Width, 90 + lblUnits.Height + 5);
