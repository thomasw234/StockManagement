...
namespace BackOffice
{
    class frmDateInput : Form
    {
        ...
        {
            cFrmForeColour = Color.FromArgb(255, 255, 85);
            cFrmBackColour = Color.FromArgb(0, 0, 170);
            sFontName = "Franklin Gothic Medium";
        ...
        public void SetupForm()
        {
            ...
            lblInstruction.Text = "Today's date is " + sCurrentDate + ", press enter to confirm that this is correct date to collect for, or enter the correct date (DDMMYY).";
        ...
        private string AddSeperators(string sDateTimeString)
        {
            ...
            string sYear = sDateTimeString[4].ToString() + sDateTimeString[5].ToString();
        ...
        private string WorkOutDateString()
        {
            ...
            return sDay + sMonth + sYear[2].ToString() + sYear[3].ToString();
        }
